        ...
        <header className='relative h-[80vh] w-full overflow-hidden flex items-center justify-center'>
            ...
            <div className='relative z-10 text-white text-center p-4'>
                <h1 className='text-4xl md:text-6xl font-bold leading-12 tracking-wider'>
                    Find Your Dream <br /> Home In Florida
                </h1>
                <p className='text-lg md:text-2xl mt-4'>
                    Get your dream apartment here
                </p>
                <Button
                    title='Explore'
                    style='mt-8 px-6 text-lg md:px-8 py-2 rounded bg-primary tracking-wider md:text-xl hover:bg-secondary'
                />
            </div>
        </header>
    );
